...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function search() {
      ...
      this.nameTargets.forEach(function (el, i) {
        var name = el.getAttribute('data-name');

        if (_this2.match(name, _this2.query)) {
    ...
    key: "match",
    value: function match(word, query) {
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-e806daea00a04f2feca9.js.map